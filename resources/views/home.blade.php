        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li style="font-size: 30px"><a style="color: #c3ad95;" href="#"><i class="fa fa-calendar-o" aria-hidden="true"></i>jose vitulich</a></li>

                    <li style="font-size: 30px"><a style="color: #c3ad95;" href="#"><i class="fa fa-calendar-o" aria-hidden="true"></i>seba</a></li>
